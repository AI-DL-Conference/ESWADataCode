...
def main():
    ...
    # network1 = train(network1, embedding_no_train, label_no_train, args.lr, args.weight_decay, 1000)
    ...
    network2 = train(network2, embedding_yes_train, label_yes_train, args.lr, 0, 2500)
